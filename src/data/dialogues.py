class Dialogue():
    def __init__(self):
        ...
        self.current_settings = "Поточні налаштування"
        self.score_to_win = "Кількість слів"
        self.score_to_win_additional = "(які потрібно відгадати для перемоги)"
        self.round_time = "Тривалість раунду"
        self.round_time_additional = "(час у секундах для кожного раунду)"
        self.settings_saved = "Налаштування збережено ✅"
